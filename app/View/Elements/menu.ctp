                        ...
                        <div class="span12">
                                ...
                                <div class="row-nav navbar">
                                        <div class="navbar-inner">
                                                <ul id="nav" class="nav">
                                                        <li class="main_nav home_menu <?php
                                                        if ($this->here == '/') {
                                                                echo "selected";
                                                        }
                                                        ?>"><?php echo $this->Html->link('Accueil', array('controller' => 'pages', 'action' => 'display', 'home')) ?></li>
                                                        <li class="main_nav about_menu <?php
                                                        if ($this->here == '/a-propos') {
                                                                echo "selected";
                                                        }
                                                        ...
                                                        <li class="dropdown soutiens_menu" class="main_nav"><a href="#" class="dropdown-toggle"
                                                                ...
                                                                <ul class="dropdown-menu js-activated" style="display: none;">
                                                                        <li <?php
                                                                        if ($this->here == '/fondation-theodora') {
                                                                                echo "selected";
                                                                        }
                                                        ...
                                                        <li class="main_nav contact_menu <?php
